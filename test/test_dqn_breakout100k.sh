...
python run_qnet.py --algo C51 $ENV $LR $TRAIN $MODEL $OPTIMIZER $OPTIONS --hl_gauss
...
python run_qnet.py --algo SPR $ENV $LR $TRAIN $MODEL $OPTIMIZER $OPTIONS --soft_reset --hl_gauss
OPTIONS="--gradient_steps 2"
python run_qnet.py --algo BBF $ENV $LR $TRAIN $MODEL $OPTIMIZER $OPTIONS
python run_qnet.py --algo BBF $ENV $LR $TRAIN $MODEL $OPTIMIZER $OPTIONS --hl_gauss