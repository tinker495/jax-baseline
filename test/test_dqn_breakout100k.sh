...
TRAIN="--steps 1e5 --batch 32 --train_freq 4 --final_eps 0.01 --learning_starts 1600 --gamma 0.99 --buffer_size 1e5 --exploration_fraction 0.2 --use_checkpointing"
...
# High replay ratio
TRAIN="--steps 1e5 --batch 32 --train_freq 1 --final_eps 0.01 --learning_starts 1600 --gamma 0.99 --buffer_size 1e5 --exploration_fraction 0.2 --use_checkpointing"
