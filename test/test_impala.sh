...
TRAIN="--steps 1e5 --batch 128 --gamma 0.995 --lamda 1.0 --worker 8 --ent_coef 1e-5"
...
OPTIONS="--sample_size 8 --update_freq 100 --val_coef 0.6 --buffer_size 256" #--buffer_size 32
