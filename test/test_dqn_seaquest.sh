...
EXPERIMENT_NAME="--experiment_name DQN_Seaquest"
ENV="--env SeaquestNoFrameskip-v4"
LR="--learning_rate 0.0001"
TRAIN="--steps 5e6 --batch 32 --train_freq 4 --final_eps 0.01 --learning_starts 20000 --gamma 0.99 --buffer_size 1e5 --exploration_fraction 0.2 --use_checkpointing"
