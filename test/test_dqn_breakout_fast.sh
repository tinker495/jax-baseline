...
TRAIN="--learning_rate 0.0001 --steps 1e7 --batch 32 --train_freq 4 --target_update 1000 --final_eps 0.05 --learning_starts 1000 --gamma 0.99 --buffer_size 1e5 --exploration_fraction 0.3"
