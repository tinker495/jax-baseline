...
TRAIN="--learning_rate 0.0002 --steps 5e5 --batch 32 --train_freq 1 --target_update 1000 --final_eps 0.01 --learning_starts 20000 --gamma 0.99 --buffer_size 1e5 --exploration_fraction 0.3"
