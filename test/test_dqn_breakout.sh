...
python run_qnet.py --algo IQN --env BreakoutNoFrameskip-v4 --learning_rate 0.0002 --steps 1e7 --batch 32 --train_freq 1 --target_update 10000 --node 512 --hidden_n 1 --final_eps 0.05 --learning_starts 20000 --gamma 0.99 --buffer_size 2e5
