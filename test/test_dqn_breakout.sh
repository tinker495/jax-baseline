...
TRAIN="--steps 1e7 --batch 32 --train_freq 4 --target_update 1000 --final_eps 0.001 --learning_starts 20000 --gamma 0.99 --buffer_size 1e6 --exploration_fraction 0.3"
MODEL="--node 512 --hidden_n 1 --dueling --double --noisynet --per --n_step 2"
OPTIONS=""
