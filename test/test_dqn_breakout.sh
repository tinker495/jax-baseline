...
TRAIN="--steps 5e5 --batch 32 --train_freq 1 --target_update 1000 --final_eps 0.01 --learning_starts 20000 --gamma 0.995 --buffer_size 1e5 --exploration_fraction 0.1"
MODEL="--node 512 --hidden_n 1 --n_step 3 --per"
