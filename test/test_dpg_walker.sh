...
python  run_dpg.py --algo TD4_QR $ENV $LR $TRAIN $MODEL $OPTIMIZER $OPTIONS
python  run_dpg.py --algo TQC $ENV $LR $TRAIN $MODEL $OPTIMIZER $OPTIONS
python  run_dpg.py --algo TD4_IQN $ENV $LR $TRAIN $MODEL $OPTIMIZER $OPTIONS
python  run_dpg.py --algo TQC_IQN $ENV $LR $TRAIN $MODEL $OPTIMIZER $OPTIONS
