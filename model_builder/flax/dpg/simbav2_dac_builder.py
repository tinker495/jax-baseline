...
class OptimisticActor(nn.Module):
    action_size: tuple
    node: int = 256
    hidden_n: int = 2
...
def model_builder_maker(observation_space, action_size, policy_kwargs):
    ...
    def model_builder(key=None, print_model=False):
        ...
        optimistic_model = OptimisticActor(action_size, **policy_kwargs)
        ...
        optimistic_fn = get_apply_fn_flax_module(optimistic_model)
        ...
        if key is not None:
            ...
            optimistic_params = optimistic_model.init(
                key,
