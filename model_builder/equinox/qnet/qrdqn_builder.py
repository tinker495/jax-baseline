    ...
    def __call__(
        ...
        *,
        ...
        if not self.dueling:
            ...
            return logits.reshape((hidden.shape[0], self.action_dim, self.support_n))
        ...
        return value + advantage - jnp.max(advantage, axis=1, keepdims=True)
