...
class A2C(Actor_Critic_Policy_Gradient_Family):
    def __init__(self, env, gamma=0.99, learning_rate=5e-5, epoch_size=1000, gradient_steps=1, batch_size=32,
        ...
        super(A2C, self).__init__(env, gamma, learning_rate, epoch_size, gradient_steps, batch_size,
