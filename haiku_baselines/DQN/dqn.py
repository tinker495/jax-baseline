...
class DQN(Q_Network_Family):
    def __init__(self, env, gamma=0.99, learning_rate=5e-4, buffer_size=100000, exploration_fraction=0.3,
    ...
    def _target(self,params, target_params, obses, actions, rewards, nxtobses, not_dones, key):
        ...
        if self.munchausen:
            ...
            next_vals = jnp.sum((pi_target * (jnp.take_along_axis(next_q, next_actions, axis=1) - tau_log_pi_next)) * not_dones, axis=1, keepdims=True)
