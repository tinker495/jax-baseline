...
class QRDQN(Q_Network_Family):
    def __init__(self, env, gamma=0.995, learning_rate=3e-4, buffer_size=100000, exploration_fraction=0.3, n_support = 200, delta = 1.0,
    ...
    def setup_model(self):
        ...
        self.quantile = jax.lax.stop_gradient(jax.device_put(jnp.expand_dims(self.quantile,axis=(0,1))))                 # [1 x 1 x support]
