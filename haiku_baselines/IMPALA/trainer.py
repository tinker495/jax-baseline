...
class Impala_Trainer(object):
    def __init__(self, learning_rate, minibatch_size, replay=False, batch_size = 1024, network_builder=None, train_builder=None, optimizer="rmsprop", logger_server=None, key=42):
